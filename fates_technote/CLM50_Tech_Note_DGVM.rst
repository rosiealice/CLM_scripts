...
:ref:`{oleson2013}` may be depicted as:
...
:ref:`{smith2001,xiaodong2005,sato2007}`
...
:ref:`{purves2008}`. Their argument follows the development
...
:ref:`{purves2008}` , we use an exponent, identical to that
...
:math:`L_c` is calculated as :ref:`{fisher2010}`
...
[8]_:ref:`{purves2008}` estimated the ratio between canopy and
...
:ref:`{kucharik1998}` estimated that SAI visible from an
LAI2000 sensor was around 0.5 m^2 m^-2. :ref:`{low2001}`
...
is based on the work of :ref:`{norman1979}`.
...
plants is based on the model of :ref:`{farquhar1980}` as
modified by :ref:`{collatz1991}`. Photosynthetic assimilation
in C4 plants is based on the model of :ref:`{collatz1992}`.
...
:ref:`{oleson2013}`. :math:`V_{c,max}` is the leaf layer
...
nitrogen through the leaf profile, see :ref:`{bonan2012}` for
...
:ref:`{lloyd2010}` who determined, from 204 vertical profiles
...
derived from :ref:`{ryan1991}`. The base rate for leaf
...
baseline temperature used by :ref:`{ryan1991}`. The
...
model as described by :ref:`{collatz1991}` and implemented in
a global climate model by :ref:`{sellers1996}`. The model
...
:ref:`{collatz1991}` and :ref:`{sellers1996}` is
...
:ref:`{sellers1996}` used :math:`b` = 10000 for C\ :math:`_3`
...
allocation in arabidopsis by :ref:`{smith2007}`.
...
using the function used by :ref:`{mc_2001}` where :math:`d_w`
...
[18]_. The phenology model of :ref:`{botta2000}` is used in
...
below a threshold determined by :ref:`{botta2000}` as
...
where a = -68, b= 638 and c=-0.01 :ref:`{botta2000}`. In the
...
seeds, taken from :ref:`{lischke2006}`. Firstly, the rate at
...
of it’s mechanistic complexity (see :ref:`{mcdowell2013}`for
...
temperature and humidity (Eqn 5, :ref:`{thonicke2010}`).
...
propagating flux calculated as (see :ref:`{thonicke2010}`
Appendix A).
...
set of expressions (from :ref:`{thonicke2010}` Appendix A).:
...
class *fc* (Eqn B1, B4 and B5, :ref:`{thonicke2010}`). The
...
the litter size class following :ref:`{peterson1986}` (page
...
:ref:`{thonicke2010}` Eqn 14, derived from Canadian Forest
...
following :ref:`{byram1959}`, and is proportional to a plant
...
cambial heating (minutes) (Eqn 8, :ref:`{peterson1986}`):
